...
public class RunInheritanceDemo {
    ...
    private static final String METHOD_CLASS      = "smalldemos/inheritance/InheritanceDemo"; 
    private static final String METHOD_DESCRIPTOR = "()V"; 
    private static final String METHOD_NAME       = "entryPoint"; 
    private static final Path   OUT_FILE          = EXAMPLES_HOME.resolve("out/runInheritanceDemo.txt");
